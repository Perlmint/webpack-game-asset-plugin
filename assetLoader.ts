...
export default function(this: wp.loader.LoaderContext, content: Buffer) {
    ...
    if (query["info"]) {
        ...
        const referencedAssets = _.filter(refModule.dependencies, d => d.module != null && d.request !== "webpack-game-asset-plugin/helper" && _.some(d.module.loaders, l => l.loader === __filename));
